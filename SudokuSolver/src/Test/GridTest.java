...
public class GridTest extends Application {
	...
	public void start(final Stage stage) {
		...
		// style the grid so that it has a background and gaps around the grid and
		// between the
		...
		// turn layout pixel snapping off on the grid so that grid lines will be an even
		// width.
		...
		// can be uncommented to show the grid lines for debugging purposes, but not
		// particularly useful for styling purposes.
