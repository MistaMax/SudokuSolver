...
public class SudokuController {
	Possibility curr;
	private Stack<Possibility> saved;
	
	private int stackCount;
	
	private long stepCount;
	
	private long stacksGenerated;
	
	private boolean skipSolve;
	
	private boolean solved;
	
	private boolean displayPossibilities;
	
	public SudokuController(int[][] puzzle) {
		skipSolve = false;
	...
	public int[][] getSudokuPuzzle(){
		return curr.sudPuzzle;
	}
	
	public void setSudokuPuzzle(int[][] puzzle) {
		//put more testing stuff in here
		curr.sudPuzzle = puzzle;
	}
	/**
	 ...
	 * @param y
	 */
	private void genOverPoss(int x, int y) {
		int count = 0;
	 ...
	 * @return
	 */
	private int getCube(int x, int y) {
		int xd3 = x / 3;
		int yd3 = y / 3;
		yd3 *= 3;
		return xd3 + yd3;
	 ...
	 * @param tmp
	 */
	private void printPossibilities(Possibility tmp) {
		for(int x = 0; x < 9; x++) {
			for(int y = 0; y < 9; y++) {
